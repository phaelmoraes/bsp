            ...
            <div class="col-lg-12">
                ...
                <div class="card-header">
                    <h3 class="card-title">Empréstimo</h3>
                        ...
                        <a href="{{url('inspection/week')}}"class="btn btn-success  btn-sm">Última semana</a>
                        <a href="{{url('inspection/month')}}"class="btn btn-primary  btn-sm">Mês atual</a>
                        <a href="{{url('inspection/year')}}"class="btn btn-info  btn-sm">Ano atual</a>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  <td>{{ $content->region_name }}</td>
                                  <td>R$ {{ number_format($content->total_value,2,",",".") }}</td>
