                ...
                <div class="col-lg-12">
                    <div class="card card-outline card-danger">
                        <div class="card-header">
                            <h3 class="card-title">Histórico do Cliente - {{$loans[0]->consumer->name}}</h3>
                                ...
                                <table class="table table_base" id="example1" name="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ number_format($loan->total_price,2,',','.') }}</td>
                                            <td>{{ $loan->fees }} %</td>
                                            <td>{{ $loan->installments }} parcela(s)</td>
                                            <td>
                                                @if($loan->status == 'paid')
                                                ...
                                                <span class="badge badge-danger">Renegociado</span>
                                                @endif
                                            ...
                                            <td>
                                                <a href="{{ route('detalheParcela', ['id' => $loan->id]) }}" class="btn btn-danger btn-sm">Detalhes</a>
                                            </td>
                                        </tr>
                                        @endforeach
