                ...
                <div class="col-lg-12">
                    <div class="card card-outline card-danger">
                        <div class="card-header">
                            <h3 class="card-title">Histórico de clientes</h3>
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="/detalhes" method="POST" class="p-4 border rounded shadow-sm bg-light">
                                @csrf
                                <div class="row col-md-12 align-items-center">
                                    <div class="col-md-12">
                                        <label for="consumer" class="form-label">Selecione o Cliente</label>
                                        <select class="form-select" id="consumer" name="consumer" required>
                                            <option value="" disabled selected>Escolha um cliente</option>
                                            <!-- Opções aqui -->
                                        </select>
                                    </div>

                                    <div class="col-md-3 d-flex align-items-end mt-3 mx-auto text-center">
