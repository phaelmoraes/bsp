                    ...
                    <form action="/consumer/edit/{{$consumer->id}}" method="POST">
                      ...
                      <div class="form-row">
                        ...
                        <label for="lastName">CPF/CNPJ</label>
                            @if($consumer->type == "PF")
                                <input type="text" onfocus="javascript: retirarFormatacao(this);" onblur="javascript: formatarCampo(this);" maxlength="14" class="form-control" id="cpf_cnpj" value="{{$consumer->cpf}}" name="cpf_cnpj"/>
                            @else
                                <input type="text" onfocus="javascript: retirarFormatacao(this);" onblur="javascript: formatarCampo(this);" maxlength="14" class="form-control" id="cpf_cnpj" value="{{$consumer->cnpj}}" name="cpf_cnpj"/>
                            @endif
